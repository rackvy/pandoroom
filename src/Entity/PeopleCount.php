...
#[ORM\Entity(repositoryClass: PeopleCountRepository::class)]
class PeopleCount
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'people_count', targetEntity: Quest2::class)]
    ...
    public function removeQuest2(Quest2 $quest2): self
    {
        if ($this->quest2s->removeElement($quest2)) {
            ...
            if ($quest2->getPeopleCount() === $this) {
                $quest2->setPeopleCount(null);
            }
        }
